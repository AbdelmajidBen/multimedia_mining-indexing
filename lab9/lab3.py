...
# View mode state
view_mode = 'solid'  # Options: 'solid', 'wireframe', 'points'
...
def draw_bezier_surface():
    ...
    # Draw Bézier surface based on view mode
...
def keyboard(key, x, y):
    global selected_point, control_points, view_mode
